...
class MenuContentTests : BaseTest() {
    ...
    fun `entree_menu_item_content`() {
        ...
        onView(withId(R.id.cauliflower_price))
            .check(matches(withText(containsString(pricePrefix + "7.00"))))
        ...
        onView(withId(R.id.chili_price))
            .check(matches(withText(containsString(pricePrefix + "4.00"))))
        ...
        onView(withId(R.id.pasta_price))
            .check(matches(withText(containsString(pricePrefix + "5.50"))))
    ...
    fun `side_menu_item_content`() {
        ...
        onView(withId(R.id.salad_price))
            .check(matches(withText(containsString(pricePrefix + "2.50"))))
        ...
        onView(withId(R.id.soup_price))
            .check(matches(withText(containsString(pricePrefix + "3.00"))))
        ...
        onView(withId(R.id.potato_price))
            .check(matches(withText(containsString(pricePrefix + "2.00"))))
        ...
        onView(withId(R.id.rice_price))
            .check(matches(withText(containsString(pricePrefix + "1.50"))))
    }
    ...
    fun `accompaniment_menu_item_content`() {
        ...
        onView(withId(R.id.bread_price))
            .check(matches(withText(containsString(pricePrefix + "0.50"))))
        ...
        onView(withId(R.id.berries_price))
            .check(matches(withText(containsString(pricePrefix + "1.00"))))
